  ...
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://ik.imagekit.io/FLATUPGYM/2.jpg?updatedAt=1751535141684)',
      ...
      <div className="container relative z-10">
        ...
        >
          <h2 className="sakuma-title text-white mb-4 drop-shadow-lg">
            女性が一番輝ける場所
          </h2>
          <p className="sakuma-body text-white/90 max-w-3xl mx-auto drop-shadow-md">
            FLATUPGYM は、女性のための格闘技ジムです。<br />
            <span className="font-black text-[#FF9A9E]">安心・楽しさ・強さ</span>を同時に手に入れられます。
          </p>
        </motion.div>
